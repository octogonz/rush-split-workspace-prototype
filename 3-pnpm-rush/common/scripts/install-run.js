 ...
 */
function _syncNpmrc(logger, sourceNpmrcFolder, targetNpmrcFolder, useNpmrcPublish, sourceNpmrcFilename) {
    ...
    const sourceNpmrcPath = path.join(sourceNpmrcFolder, resolvedSourceNpmrcFilename);
